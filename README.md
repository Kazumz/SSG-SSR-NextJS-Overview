...
- Upon completion, your browser will "paint/render" this for you on screen. The HTML instructs the browser what the layout of this particular page is. 
...
As with SSG, React will still perform rehydration and reconciliation when in the browser as you may not have access to everything you need server side such as accessing some browser based API's.
...
- Download JavaScript
- React rehydration and reconciliation, writing any additional HTML to the DOM if required.
...
## Credits
A little bit of my own brain power;
